...
module TinasApp {
    ...
    export interface ICoursesDirectiveScope extends ng.IScope {
        courseData: any;
    }

    export class CoursesDirective extends BaseDirective<ICoursesDirectiveScope> {
        ...
        public initialize($scope: ICoursesDirectiveScope, element: JQuery, attributes: ng.IAttributes): void {
            this.getData().then((d) => {
                $scope.courseData = d;
                console.log("data gotten");
                var msg = new RefreshSkrollr();
